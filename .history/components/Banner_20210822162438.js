    ...
    return (
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px]">
            ...
            <div className="absolute top-1/2 w-full text-center">
                ...
                <button className="  bg-white rounded-full px-10 py-4 shadow-md font-bold hover:shadow-xl active:scale-90 transition duration-150"><span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">I'm flexible</span></button>
            </div>
        </div>
    )
}

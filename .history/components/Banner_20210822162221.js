    ...
    return (
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px]">
            ...
            <div className="absolute top-1/2 w-full text-center">
                ...
                <button className="  bg-white rounded-full px-10 py-4 shadow-md font-bold hover:shadow-xl active:scale-90 transition duration-150"><span    I'm flexible</button>
            </div>
        </div>
    )
}

...
function Header({ placeholder }) {
    ...
    // Declare router to link to another page
    const router = useRouter();
    const search = () => {
        router.push({
            // to jump to search page
            pathname: "/search",
        ...
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-4 px-5 md:px-10">
            ...
            <div className="flex items-center border-2 rounded-full py-2 px-1 shadow-sm ">
                <input
                    ...
                    type="text"
                    placeholder={placeholder || "start your search"} className="pl-2 pg-transparent outline-none flex-grow text-gray-600 text-sm placeholder-gray-400" />
